...
const ENABLE_THINKING_MODE = false; // Set to false to enable chat_template_kwargs thinking parameter

// 🔥 FORCE DETAILED RESPONSES - Adds system prompt to encourage longer outputs
...
const MODEL_MAPPING = {
  ...
  'gpt-4o': 'z-ai/glm-5.1',
  'claude-3-opus': 'qwen/qwen3-next-80b-a3b-instruct',
